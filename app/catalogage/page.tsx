            ...
            {filtered.map(game => {
              ...
              return (
                <div key={game.ean}
                  ...
                  onKeyDown={e => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); setEditGame(game); } }}
                  style={{
                  ...
                  {/* Checkbox */}
                  <div onClick={e => { e.stopPropagation(); toggleSelect(game.ean); }}
                    style={{
                  ...
                  {/* Bouton */}
                  <button onClick={e => { e.stopPropagation(); setEditGame(game); }} className="pop-btn pop-btn-outline" style={{ fontSize: 12, padding: "5px 12px", flexShrink: 0 }}>
                    ✏️ Cataloguer
                  </button>
                </div>
              );
